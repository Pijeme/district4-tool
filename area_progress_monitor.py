...
<script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
  <style>
    ...
    *{box-sizing:border-box} html{scroll-behavior:smooth} body{margin:0;font-family:Arial,Helvetica,sans-serif;background:var(--bg);color:var(--text)}
    ...
    .apm-hero-card{background:linear-gradient(180deg,#a7f3ff 0%,#38bdf8 55%,#0ea5e9 100%);color:#fff;border-radius:24px;padding:22px 86px 22px 22px;margin-bottom:14px;box-shadow:0 18px 38px rgba(14,165,233,.20);position:relative;overflow:visible;min-height:150px}.apm-hero-card:before{content:"";position:absolute;inset:-80px -80px auto auto;width:220px;height:220px;background:rgba(255,255,255,.18);border-radius:999px;pointer-events:none}.apm-hero-content{position:relative;display:block;min-height:105px}.apm-hero-card h1{margin:0;font-size:30px;line-height:1.06;font-family:"Trebuchet MS","Segoe UI",Arial,sans-serif;letter-spacing:-.04em;text-shadow:0 3px 14px rgba(0,0,0,.14);padding-right:4px}.apm-hero-card .subtitle{color:rgba(255,255,255,.98);font-weight:700;text-shadow:0 2px 10px rgba(0,0,0,.14)}
    .top-actions{display:flex;align-items:center;gap:8px}.notif-wrap{position:absolute;top:18px;right:18px;z-index:90}.notif-btn{width:56px;height:56px;border-radius:18px;border:1px solid rgba(255,255,255,.34);background:#111827;color:#fff;font-size:24px;display:inline-flex;align-items:center;justify-content:center;position:relative;box-shadow:0 14px 32px rgba(15,23,42,.42)}.notif-badge{position:absolute;top:-7px;right:-7px;min-width:23px;height:23px;border-radius:999px;background:#ef4444;color:#fff;border:2px solid #fff;font-size:11px;font-weight:900;display:none;align-items:center;justify-content:center;padding:0 5px}.notif-panel{position:absolute;right:0;top:64px;width:min(370px,calc(100vw - 32px));background:#fff;color:#10324a;border:1px solid #b8e6ff;border-radius:18px;box-shadow:0 18px 44px rgba(15,23,42,.28);display:none;overflow:hidden;z-index:999}.notif-panel.open{display:block}.notif-head{padding:12px 14px;background:linear-gradient(135deg,#e0f7ff,#ffffff);font-weight:900;color:#075985;border-bottom:1px solid #b8e6ff}.notif-list{max-height:430px;overflow:auto;background:#fff}.notif-item{padding:12px 14px;border-bottom:1px solid #f1f5f9;background:#fff}.notif-title{font-weight:900;color:#10324a;font-size:13px}.notif-msg{font-size:13px;color:#475569;line-height:1.4;margin-top:3px}.notif-kind{display:inline-flex;margin-top:7px;font-size:11px;border-radius:999px;padding:4px 8px;background:#e0f7ff;color:#075985;border:1px solid #b8e6ff}.notif-empty{padding:16px;color:#64748b;font-size:13px;background:#fff}
    @media (max-width:700px){.apm-hero-card{padding:22px 92px 22px 22px;min-height:154px}.apm-hero-card h1{font-size:28px;max-width:100%;word-break:normal}.notif-wrap{top:18px;right:18px}.notif-panel{position:absolute;right:0;top:66px;width:calc(100vw - 40px);max-width:360px}.notif-list{max-height:52vh}}
